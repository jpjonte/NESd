...
### Fixed
- A save state that cannot be read no longer stops the game from starting: the game boots from power-on and the failure is reported
...
- Fixed a bug in the noise channel leading to incorrect sounds
