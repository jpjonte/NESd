...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,volume,stretch,showBorder,showTiles,showCartridgeInfo,showDebugOverlay,showDebugger,scaling,autoSave,autoSaveInterval,autoLoad,const DeepCollectionEquality().hash(bindings),lastRomPath,const DeepCollectionEquality().hash(recentRomPaths),const DeepCollectionEquality().hash(recentRoms),showTouchControls,const DeepCollectionEquality().hash(narrowTouchInputConfig),const DeepCollectionEquality().hash(wideTouchInputConfig),const DeepCollectionEquality().hash(breakpoints),const DeepCollectionEquality().hash(cheats),region,themeMode,renderer,rewind,pixelAspectRatio,customPixelAspectRatio]);
