...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,volume,stretch,showBorder,showTiles,showCartridgeInfo,showDebugOverlay,showDebugger,showApuDebug,scaling,autoSave,autoSaveInterval,autoLoad,const DeepCollectionEquality().hash(_bindings),lastRomPath,const DeepCollectionEquality().hash(_recentRomPaths),const DeepCollectionEquality().hash(_recentRoms),showTouchControls,const DeepCollectionEquality().hash(_narrowTouchInputConfig),const DeepCollectionEquality().hash(_wideTouchInputConfig),const DeepCollectionEquality().hash(_breakpoints),const DeepCollectionEquality().hash(_cheats),region,themeMode,renderer,rewind,pixelAspectRatio,customPixelAspectRatio]);
