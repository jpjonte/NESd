...
int get hashCode {
  final _this = this as Settings;
  return Object.hashAll([runtimeType,_this.volume,_this.lowPassFilter,_this.swapDutyCycles,_this.fastForwardSpeed,_this.turboSpeed,_this.stretch,_this.showBorder,_this.showDebugOverlay,_this.logLevel,const DeepCollectionEquality().hash(_this.openTools),_this.scaling,_this.autoSave,_this.autoSaveInterval,_this.autoLoad,const DeepCollectionEquality().hash(_this.bindings),_this.bindingsVersion,_this.lastRomPath,const DeepCollectionEquality().hash(_this.recentRomPaths),const DeepCollectionEquality().hash(_this.recentRoms),_this.showTouchControls,const DeepCollectionEquality().hash(_this.narrowTouchInputConfig),const DeepCollectionEquality().hash(_this.wideTouchInputConfig),const DeepCollectionEquality().hash(_this.breakpoints),const DeepCollectionEquality().hash(_this.cheats),_this.region,_this.themeMode,_this.renderer,_this.rewind,_this.pixelAspectRatio,_this.customPixelAspectRatio,const DeepCollectionEquality().hash(_this.videoFilters),_this.crtFilter,_this.overscan,_this.paletteId,_this.ntscPalette]);
}

@override
String toString() {
  final _this = this as Settings;
  return 'Settings(volume: ${_this.volume}, lowPassFilter: ${_this.lowPassFilter}, swapDutyCycles: ${_this.swapDutyCycles}, fastForwardSpeed: ${_this.fastForwardSpeed}, turboSpeed: ${_this.turboSpeed}, stretch: ${_this.stretch}, showBorder: ${_this.showBorder}, showDebugOverlay: ${_this.showDebugOverlay}, logLevel: ${_this.logLevel}, openTools: ${_this.openTools}, scaling: ${_this.scaling}, autoSave: ${_this.autoSave}, autoSaveInterval: ${_this.autoSaveInterval}, autoLoad: ${_this.autoLoad}, bindings: ${_this.bindings}, bindingsVersion: ${_this.bindingsVersion}, lastRomPath: ${_this.lastRomPath}, recentRomPaths: ${_this.recentRomPaths}, recentRoms: ${_this.recentRoms}, showTouchControls: ${_this.showTouchControls}, narrowTouchInputConfig: ${_this.narrowTouchInputConfig}, wideTouchInputConfig: ${_this.wideTouchInputConfig}, breakpoints: ${_this.breakpoints}, cheats: ${_this.cheats}, region: ${_this.region}, themeMode: ${_this.themeMode}, renderer: ${_this.renderer}, rewind: ${_this.rewind}, pixelAspectRatio: ${_this.pixelAspectRatio}, customPixelAspectRatio: ${_this.customPixelAspectRatio}, videoFilters: ${_this.videoFilters}, crtFilter: ${_this.crtFilter}, overscan: ${_this.overscan}, paletteId: ${_this.paletteId}, ntscPalette: ${_this.ntscPalette})';
}
...
$CrtFilterSettingsCopyWith<$Res> get crtFilter;$OverscanCopyWith<$Res> get overscan;$NtscPaletteSettingsCopyWith<$Res> get ntscPalette;
...
@override $CrtFilterSettingsCopyWith<$Res> get crtFilter;@override $OverscanCopyWith<$Res> get overscan;@override $NtscPaletteSettingsCopyWith<$Res> get ntscPalette;
