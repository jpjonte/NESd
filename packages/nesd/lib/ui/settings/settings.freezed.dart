...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,volume,stretch,showBorder,showDebugOverlay,const DeepCollectionEquality().hash(openTools),scaling,autoSave,autoSaveInterval,autoLoad,const DeepCollectionEquality().hash(bindings),lastRomPath,const DeepCollectionEquality().hash(recentRomPaths),const DeepCollectionEquality().hash(recentRoms),showTouchControls,const DeepCollectionEquality().hash(narrowTouchInputConfig),const DeepCollectionEquality().hash(wideTouchInputConfig),const DeepCollectionEquality().hash(breakpoints),const DeepCollectionEquality().hash(cheats),region,themeMode,renderer,rewind,pixelAspectRatio,customPixelAspectRatio]);
...
switch (_that) {
case _Settings() when $default != null:
return $default(_that.volume,_that.stretch,_that.showBorder,_that.showDebugOverlay,_that.openTools,_that.scaling,_that.autoSave,_that.autoSaveInterval,_that.autoLoad,_that.bindings,_that.lastRomPath,_that.recentRomPaths,_that.recentRoms,_that.showTouchControls,_that.narrowTouchInputConfig,_that.wideTouchInputConfig,_that.breakpoints,_that.cheats,_that.region,_that.themeMode,_that.renderer,_that.rewind,_that.pixelAspectRatio,_that.customPixelAspectRatio);case _:
  return orElse();
