...
switch (_that) {
case _Settings() when $default != null:
return $default(_that.volume,_that.stretch,_that.showBorder,_that.showDebugOverlay,_that.logLevel,_that.openTools,_that.scaling,_that.autoSave,_that.autoSaveInterval,_that.autoLoad,_that.bindings,_that.bindingsVersion,_that.lastRomPath,_that.recentRomPaths,_that.recentRoms,_that.showTouchControls,_that.narrowTouchInputConfig,_that.wideTouchInputConfig,_that.breakpoints,_that.cheats,_that.region,_that.themeMode,_that.renderer,_that.rewind,_that.pixelAspectRatio,_that.customPixelAspectRatio,_that.videoFilter,_that.crtFilter);case _:
  return orElse();
