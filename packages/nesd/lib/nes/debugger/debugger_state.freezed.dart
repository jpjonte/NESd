...
@override
int get hashCode => Object.hashAll([runtimeType,enabled,const DeepCollectionEquality().hash(disassembly),PC,A,X,Y,SP,P,C,Z,I,D,B,V,N,irq,nmi,const DeepCollectionEquality().hash(stack),const DeepCollectionEquality().hash(breakpoints),canStepOut,scanline,cycle,v,t,x,spriteOverflow,sprite0Hit,vBlank,showStack,selectedAddress]);
