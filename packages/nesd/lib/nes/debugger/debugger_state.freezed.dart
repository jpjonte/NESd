...
bool operator ==(Object other) {
  final _this = this as DebuggerState;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DebuggerState&&(identical(other.enabled, _this.enabled) || other.enabled == _this.enabled)&&const DeepCollectionEquality().equals(other.disassembly, _this.disassembly)&&(identical(other.PC, _this.PC) || other.PC == _this.PC)&&(identical(other.A, _this.A) || other.A == _this.A)&&(identical(other.X, _this.X) || other.X == _this.X)&&(identical(other.Y, _this.Y) || other.Y == _this.Y)&&(identical(other.SP, _this.SP) || other.SP == _this.SP)&&(identical(other.P, _this.P) || other.P == _this.P)&&(identical(other.C, _this.C) || other.C == _this.C)&&(identical(other.Z, _this.Z) || other.Z == _this.Z)&&(identical(other.I, _this.I) || other.I == _this.I)&&(identical(other.D, _this.D) || other.D == _this.D)&&(identical(other.B, _this.B) || other.B == _this.B)&&(identical(other.V, _this.V) || other.V == _this.V)&&(identical(other.N, _this.N) || other.N == _this.N)&&(identical(other.irq, _this.irq) || other.irq == _this.irq)&&(identical(other.nmi, _this.nmi) || other.nmi == _this.nmi)&&const DeepCollectionEquality().equals(other.stack, _this.stack)&&const DeepCollectionEquality().equals(other.breakpoints, _this.breakpoints)&&(identical(other.canStepOut, _this.canStepOut) || other.canStepOut == _this.canStepOut)&&(identical(other.scanline, _this.scanline) || other.scanline == _this.scanline)&&(identical(other.cycle, _this.cycle) || other.cycle == _this.cycle)&&(identical(other.v, _this.v) || other.v == _this.v)&&(identical(other.t, _this.t) || other.t == _this.t)&&(identical(other.x, _this.x) || other.x == _this.x)&&(identical(other.spriteOverflow, _this.spriteOverflow) || other.spriteOverflow == _this.spriteOverflow)&&(identical(other.sprite0Hit, _this.sprite0Hit) || other.sprite0Hit == _this.sprite0Hit)&&(identical(other.vBlank, _this.vBlank) || other.vBlank == _this.vBlank)&&(identical(other.showStack, _this.showStack) || other.showStack == _this.showStack)&&(identical(other.selectedAddress, _this.selectedAddress) || other.selectedAddress == _this.selectedAddress));
}
...
int get hashCode {
  final _this = this as DebuggerState;
  return Object.hashAll([runtimeType,_this.enabled,const DeepCollectionEquality().hash(_this.disassembly),_this.PC,_this.A,_this.X,_this.Y,_this.SP,_this.P,_this.C,_this.Z,_this.I,_this.D,_this.B,_this.V,_this.N,_this.irq,_this.nmi,const DeepCollectionEquality().hash(_this.stack),const DeepCollectionEquality().hash(_this.breakpoints),_this.canStepOut,_this.scanline,_this.cycle,_this.v,_this.t,_this.x,_this.spriteOverflow,_this.sprite0Hit,_this.vBlank,_this.showStack,_this.selectedAddress]);
}

@override
String toString() {
  final _this = this as DebuggerState;
  return 'DebuggerState(enabled: ${_this.enabled}, disassembly: ${_this.disassembly}, PC: ${_this.PC}, A: ${_this.A}, X: ${_this.X}, Y: ${_this.Y}, SP: ${_this.SP}, P: ${_this.P}, C: ${_this.C}, Z: ${_this.Z}, I: ${_this.I}, D: ${_this.D}, B: ${_this.B}, V: ${_this.V}, N: ${_this.N}, irq: ${_this.irq}, nmi: ${_this.nmi}, stack: ${_this.stack}, breakpoints: ${_this.breakpoints}, canStepOut: ${_this.canStepOut}, scanline: ${_this.scanline}, cycle: ${_this.cycle}, v: ${_this.v}, t: ${_this.t}, x: ${_this.x}, spriteOverflow: ${_this.spriteOverflow}, sprite0Hit: ${_this.sprite0Hit}, vBlank: ${_this.vBlank}, showStack: ${_this.showStack}, selectedAddress: ${_this.selectedAddress})';
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool enabled,  Disassembly disassembly,  int PC,  int A,  int X,  int Y,  int SP,  int P,  bool C,  bool Z,  bool I,  bool D,  bool B,  bool V,  bool N,  int irq,  bool nmi,  List<int> stack,  List<Breakpoint> breakpoints,  bool canStepOut,  int scanline,  int cycle,  int v,  int t,  int x,  bool spriteOverflow,  bool sprite0Hit,  bool vBlank,  bool showStack,  int? selectedAddress)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DebuggerState() when $default != null:
return $default(_that.enabled,_that.disassembly,_that.PC,_that.A,_that.X,_that.Y,_that.SP,_that.P,_that.C,_that.Z,_that.I,_that.D,_that.B,_that.V,_that.N,_that.irq,_that.nmi,_that.stack,_that.breakpoints,_that.canStepOut,_that.scanline,_that.cycle,_that.v,_that.t,_that.x,_that.spriteOverflow,_that.sprite0Hit,_that.vBlank,_that.showStack,_that.selectedAddress);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool enabled,  Disassembly disassembly,  int PC,  int A,  int X,  int Y,  int SP,  int P,  bool C,  bool Z,  bool I,  bool D,  bool B,  bool V,  bool N,  int irq,  bool nmi,  List<int> stack,  List<Breakpoint> breakpoints,  bool canStepOut,  int scanline,  int cycle,  int v,  int t,  int x,  bool spriteOverflow,  bool sprite0Hit,  bool vBlank,  bool showStack,  int? selectedAddress)  $default,) {final _that = this;
switch (_that) {
case _DebuggerState():
return $default(_that.enabled,_that.disassembly,_that.PC,_that.A,_that.X,_that.Y,_that.SP,_that.P,_that.C,_that.Z,_that.I,_that.D,_that.B,_that.V,_that.N,_that.irq,_that.nmi,_that.stack,_that.breakpoints,_that.canStepOut,_that.scanline,_that.cycle,_that.v,_that.t,_that.x,_that.spriteOverflow,_that.sprite0Hit,_that.vBlank,_that.showStack,_that.selectedAddress);}
}
